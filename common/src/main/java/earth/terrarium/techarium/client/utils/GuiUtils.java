package earth.terrarium.techarium.client.utils;
...
public class GuiUtils {
    public static final ResourceLocation ENERGY_BAR = new ResourceLocation(Techarium.MOD_ID, "textures/icons/energy_bar.png");
    public static final int ENERGY_BAR_WIDTH = 12;
    public static final int ENERGY_BAR_HEIGHT = 48;

    public static final ResourceLocation FLUID_BAR = new ResourceLocation(Techarium.MOD_ID, "textures/icons/fluid_bar.png");
    public static final int FLUID_BAR_WIDTH = 14;
    public static final int FLUID_BAR_HEIGHT = 50;
