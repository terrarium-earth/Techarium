...
public class GravMagnetModel extends AnimatedGeoModel<GravMagnetBlockEntity> {
    ...
    public static final ResourceLocation PULL_TEXTURE = Utils.resourceLocation("textures/block/animated/gravmagnet_pull.png");
    public static final ResourceLocation PUSH_TEXTURE = Utils.resourceLocation("textures/block/animated/gravmagnet_push.png");
